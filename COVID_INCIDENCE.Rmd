...
df %>%
  ...
  geom_line(data=predicted.incidence.decrease.3,aes(x=Date,y=fit),color="green") +
  geom_line(data=predicted.incidence.decrease.3,aes(x=Date,y=lwr),color="black") +
  geom_line(data=predicted.incidence.decrease.3,aes(x=Date,y=upr),color="black") +
  
  geom_line(data=predicted.incidence.increase.4,aes(x=Date,y=fit),color="red") +
  geom_line(data=predicted.incidence.increase.4,aes(x=Date,y=lwr),color="black") +
  geom_line(data=predicted.incidence.increase.4,aes(x=Date,y=upr),color="black") +
  
  geom_line(data=predicted.incidence.decrease.4,aes(x=Date,y=fit),color="green") +
  geom_line(data=predicted.incidence.decrease.4,aes(x=Date,y=lwr),color="black") +
  geom_line(data=predicted.incidence.decrease.4,aes(x=Date,y=upr),color="black") +
  
  geom_line(data=predicted.incidence.increase.5,aes(x=Date,y=fit),color="red") +
  geom_line(data=predicted.incidence.increase.5,aes(x=Date,y=lwr),color="black") +
  geom_line(data=predicted.incidence.increase.5,aes(x=Date,y=upr),color="black") +
  
  geom_vline(xintercept = unique(floor_date(seq.Date(dmy("01-02-2020"),dmy("01-08-2030"),by="1 day"),"month")),color="gray70") +
  geom_hline(yintercept = seq(100,2000,by=100),color="gray70") + 
  
  scale_x_date(date_breaks = "1 month",limits=c(dmy("01-02-2020"),Sys.Date()+days(30)),date_labels = "%Y %b") +
  scale_y_continuous(limits=c(0,2000),breaks=seq(0,2000,by=100),expand=c(0,0)) +
...
df %>%
  ...
  geom_vline(xintercept = unique(floor_date(seq.Date(dmy("01-01-2021"),Sys.Date(),by="1 day"),"month")),color="gray70") +
  geom_hline(yintercept = seq(0,2000,by=100),color="gray70") + 
  
  scale_x_date(date_breaks = "14 days",limits=c(dmy("01-01-2021"),Sys.Date()),date_labels = "%Y %b") +
  scale_y_continuous(limits=c(0,2000),breaks=seq(0,2000,by=25),expand=c(0,0)) +
...
ggplot(df.antigen_pcr,aes(x=Dato,y=AG_pos)) +
  ...
  labs(title="Daily Positive Antigen Tests",
       ...
       caption = timestamp_caption()) +
  scale_y_continuous(labels=scales::comma,expand=c(0,0),breaks=seq(0,5000,by=250),limits=c(0,NA)) +
  scale_x_date(date_breaks = "14 days",date_labels = "%d %b %Y",expand=c(0,3)) +
  geom_smooth(span=0.2,color="gray20") + 
  theme_coviddk 
...
df.antigen_pcr %>% 
  ...
  scale_y_continuous(labels = scales::percent,expand=c(0,0),breaks=seq(0,1,by=0.01),limits=c(0,0.1)) +
...
read.csv(paste0(temp_dir,"/Test_pos_over_time.csv"),sep=";") %>% 
  ...
  labs(title="Daily New Positive Cases",x="Date",y="Daily New Positive Cases",
       caption = timestamp_caption()) +
  scale_x_date(date_breaks = "1 month",limits=c(dmy("01-02-2020"),Sys.Date()+days(7)),date_labels = "%b %Y") +
    scale_y_continuous(limits=c(0,NA),breaks=seq(0,10000,by=500),expand=c(0,0),labels=scales::comma) +
  theme_coviddk +
  geom_smooth(span=0.1)
...
read.csv(paste0(temp_dir,"/Test_pos_over_time.csv"),sep=";") %>% 
  ...
  scale_y_continuous(limits=c(0,0.1),labels = scales::percent_format(accuracy = 0.1),expand=c(0,0),breaks = seq(0,1,by=0.025)) +
...
read.csv(paste0(temp_dir,"/Test_pos_over_time.csv"),sep=";") %>% 
  ...
  labs(title="Number of PCR Tests vs. Positive-% by Month",
       ...
       caption = timestamp_caption()) +
  scale_y_continuous(limits=c(0,NA),breaks=seq(0,1,by=0.005),labels = scales::percent,expand=c(0,0))+
