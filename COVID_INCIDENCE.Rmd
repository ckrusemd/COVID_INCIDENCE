...
predicted.incidence.increase.4 <- 
  10^predict(fit.incidence.increase.4,
             data.frame(Date=seq.Date(ymd("2021-06-29"),ymd("2021-09-01"),by = "1 day"),interval = "prediction"),
        interval = "prediction") %>%
  tbl_df() %>%
  dplyr::mutate(Date=seq.Date(ymd("2021-06-29"),ymd("2021-09-01"),by = "1 day"))
...
df %>%
  ...
  scale_x_date(date_breaks = "1 month",limits=c(dmy("01-02-2020"),dmy("01-09-2021")),date_labels = "%Y %b") +
...
df %>%
  ...
  geom_vline(xintercept = unique(floor_date(seq.Date(dmy("01-01-2021"),dmy("01-09-2021"),by="1 day"),"month")),color="gray70") +
  geom_hline(yintercept = seq(0,500,by=100),color="gray70") + 
  
  scale_x_date(date_breaks = "14 days",limits=c(dmy("01-01-2021"),dmy("01-09-2021")),date_labels = "%Y %b") +
