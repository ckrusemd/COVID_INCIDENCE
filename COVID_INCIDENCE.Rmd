...
df_calendar = bind_rows(
  ...
  data.frame(Group="Gruppe 10d1",Date=as.Date("2021211", "%Y%U%u"),y=1.3*10^6),
  data.frame(Group="Gruppe 10d2",Date=as.Date("2021241", "%Y%U%u"),y=1.7*10^6),
  data.frame(Group="Gruppe 10d3",Date=as.Date("2021261", "%Y%U%u"),y=2.0*10^6),
  data.frame(Group="Gruppe 10d4",Date=as.Date("2021291", "%Y%U%u"),y=2.7*10^6)
)
