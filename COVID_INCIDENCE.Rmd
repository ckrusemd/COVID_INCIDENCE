...
# Time series
col_number = ncol(read.csv(paste0(temp_dir,"/COVID/Cases_by_age.csv"),
           sep = ";"))

# df.250 <-
  read.csv(paste0(temp_dir,"/COVID/Cases_by_age.csv"),
           sep = ";",
           encoding = "UTF-8",
           colClasses=rep("character",col_number)) %>%
...
# Time series
col_number = ncol(read.csv(paste0(temp_dir,"/COVID/Cases_by_sex.csv"),
           sep = ";"))

  read.csv(paste0(temp_dir,"/COVID/Cases_by_sex.csv"),
           sep = ";",
           encoding = "UTF-8",
           colClasses=rep("character",col_number)) %>%
    dplyr::select(-I_alt) %>% 
