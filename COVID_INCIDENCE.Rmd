...
df %>%
  ...
  geom_hline(yintercept = seq(0,800,by=100),color="gray70") + 
  
  scale_x_date(date_breaks = "14 days",limits=c(dmy("01-01-2021"),Sys.Date()),date_labels = "%Y %b") +
  scale_y_continuous(limits=c(0,800),breaks=seq(0,800,by=25),expand=c(0,0)) +
...
df %>%
  ...
  scale_y_continuous(limits=c(0,800),breaks=seq(0,800,by=25)) +
  geom_abline(slope = -1,intercept = 200) +
