...
Total Danish population (~5.82 million) incidence in the past 14 days per 100,000 citizens since the beginning of the COVID-19 pandemic.
...
predicted.incidence.increase.3 <- 
  10^predict(fit.incidence.increase.3,
             data.frame(Date=seq.Date(ymd("2021-02-16"),ymd("2021-06-08"),by = "1 day"),interval = "prediction"),
        interval = "prediction") %>%
  tbl_df() %>%
  dplyr::mutate(Date=seq.Date(ymd("2021-02-16"),ymd("2021-06-08"),by = "1 day"))

## DECREASE 3
df.fit.decrease.3 <- 
  df %>%
  filter(Date>=ymd("2021-06-08")) %>%
  filter(Date<=ymd("2021-06-29"))

fit.incidence.decrease.3 <- 
  lm(log10(INCIDENCE)~Date,data=df.fit.decrease.3)

summary(fit.incidence.decrease.3)

predicted.incidence.decrease.3 <- 
  10^predict(fit.incidence.decrease.3,
             data.frame(Date=seq.Date(ymd("2021-06-08"),ymd("2021-06-29"),by = "1 day"),interval = "prediction"),
        interval = "prediction") %>%
  tbl_df() %>%
  dplyr::mutate(Date=seq.Date(ymd("2021-06-08"),ymd("2021-06-29"),by = "1 day"))

## INCREASE 4
df.fit.increase.4 <- 
  df %>%
  filter(Date>=ymd("2021-06-29")) %>%
  filter(Date<=ymd("2021-07-15"))

fit.incidence.increase.4 <- 
  lm(log10(INCIDENCE)~Date,data=df.fit.increase.4)

summary(fit.incidence.increase.4)

predicted.incidence.increase.4 <- 
  10^predict(fit.incidence.increase.4,
             data.frame(Date=seq.Date(ymd("2021-06-29"),ymd("2021-07-15"),by = "1 day"),interval = "prediction"),
        interval = "prediction") %>%
  tbl_df() %>%
  dplyr::mutate(Date=seq.Date(ymd("2021-06-29"),ymd("2021-07-15"),by = "1 day"))
...
fit.incidence.decrease.4 <- 
  lm(log10(INCIDENCE)~Date,data=df.fit.decrease.4)

summary(fit.incidence.decrease.4)

predicted.incidence.decrease.4 <- 
  10^predict(fit.incidence.decrease.4,
             data.frame(Date=seq.Date(ymd("2021-09-01"),ymd("2021-09-15"),by = "1 day"),interval = "prediction"),
        interval = "prediction") %>%
  tbl_df() %>%
  dplyr::mutate(Date=seq.Date(ymd("2021-09-01"),ymd("2021-09-15"),by = "1 day"))
...
fit.incidence.increase.5 <- 
  lm(log10(INCIDENCE)~Date,data=df.fit.increase.5)

summary(fit.incidence.increase.5)

predicted.incidence.increase.5 <- 
  10^predict(fit.incidence.increase.5,
             data.frame(Date=seq.Date(ymd("2021-10-01"),Sys.Date()+days(14),by = "1 day"),interval = "prediction"),
        interval = "prediction") %>%
  tbl_df() %>%
  dplyr::mutate(Date=seq.Date(ymd("2021-10-01"),Sys.Date()+days(14),by = "1 day"))
...
df %>%
  ...
  geom_line(data=predicted.incidence.descent,aes(x=Date,y=lwr),color="gray60") +
  geom_line(data=predicted.incidence.descent,aes(x=Date,y=upr),color="gray60") +
  
  geom_line(data=predicted.incidence.increase,aes(x=Date,y=fit),color=rgb(255/255,0/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.increase,aes(x=Date,y=lwr),color="gray60") +
  geom_line(data=predicted.incidence.increase,aes(x=Date,y=upr),color="gray60") +
  
  geom_line(data=predicted.incidence.increase_2,aes(x=Date,y=fit),color=rgb(255/255,0/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.increase_2,aes(x=Date,y=lwr),color="gray60") +
  geom_line(data=predicted.incidence.increase_2,aes(x=Date,y=upr),color="gray60") +
  
  geom_line(data=predicted.incidence.descent.2,aes(x=Date,y=fit),color=rgb(0/255,255/255,0/255,alpha=0.5)) +
  ...
  geom_line(data=predicted.incidence.increase.3,aes(x=Date,y=fit),color=rgb(255/255,0/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.increase.3,aes(x=Date,y=lwr),color="gray60") +
  geom_line(data=predicted.incidence.increase.3,aes(x=Date,y=upr),color="gray60") +
  
  geom_line(data=predicted.incidence.decrease.3,aes(x=Date,y=fit),color=rgb(0/255,255/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.decrease.3,aes(x=Date,y=lwr),color="gray60") +
  geom_line(data=predicted.incidence.decrease.3,aes(x=Date,y=upr),color="gray60") +
  
  geom_line(data=predicted.incidence.increase.4,aes(x=Date,y=fit),color=rgb(255/255,0/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.increase.4,aes(x=Date,y=lwr),color="gray60") +
  geom_line(data=predicted.incidence.increase.4,aes(x=Date,y=upr),color="gray60") +
  
  geom_line(data=predicted.incidence.decrease.4,aes(x=Date,y=fit),color=rgb(0/255,255/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.decrease.4,aes(x=Date,y=lwr),color="gray60") +
  geom_line(data=predicted.incidence.decrease.4,aes(x=Date,y=upr),color="gray60") +
  
  geom_line(data=predicted.incidence.increase.5,aes(x=Date,y=fit),color=rgb(255/255,0/255,0/255,alpha=0.5) ) +
  geom_line(data=predicted.incidence.increase.5,aes(x=Date,y=lwr),color="gray60") +
  geom_line(data=predicted.incidence.increase.5,aes(x=Date,y=upr),color="gray60") +
  
  geom_vline(xintercept = unique(floor_date(seq.Date(dmy("01-02-2020"),dmy("01-08-2030"),by="1 day"),"month")),color="gray70") +
  geom_hline(yintercept = seq(100,12500,by=500),color="gray70") + 
  
  scale_x_date(date_breaks = "1 month",limits=c(dmy("01-02-2020"),Sys.Date()+days(30)),date_labels = "%Y %b") +
  scale_y_continuous(limits=c(0,12500),breaks=seq(0,12500,by=500),expand=c(0,0)) +
...
df %>%
  ...
  geom_line(data=predicted.incidence.increase_2,aes(x=Date,y=fit),color=rgb(0/255,255/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.increase_2,aes(x=Date,y=lwr),color="gray60") +
  geom_line(data=predicted.incidence.increase_2,aes(x=Date,y=upr),color="gray60") +
  
  geom_line(data=predicted.incidence.descent.2,aes(x=Date,y=fit),color=rgb(0/255,255/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.descent.2,aes(x=Date,y=lwr),color="gray60") +
  geom_line(data=predicted.incidence.descent.2,aes(x=Date,y=upr),color="gray60") +
  ...
  geom_vline(xintercept = unique(floor_date(seq.Date(dmy("01-01-2021"),Sys.Date()+days(14),by="1 day"),"month")),color="gray70") +
  geom_hline(yintercept = seq(0,12500,by=250),color="gray70") + 
  
  scale_x_date(date_breaks = "14 days",limits=c(dmy("01-01-2021"),Sys.Date()+days(14)),date_labels = "%Y %b") +
  scale_y_continuous(limits=c(0,12500),breaks=seq(0,12500,by=500),expand=c(0,0)) +
...
recent_30_days %>%
  arrange(desc(Date)) %>% 
  dplyr::mutate(`Daily New Positive Cases`=scales::number(`Daily New Positive Cases`,big.mark = ",")) %>% 
  dplyr::mutate(`14 Day Cumulative Cases`=scales::number(`14 Day Cumulative Cases`,big.mark = ",")) %>% 
  dplyr::mutate(`14 Day Incidence Per 100K`=scales::number(`14 Day Incidence Per 100K`,big.mark = ",",accuracy = 1)) %>% 
  knitr::kable() 
...
df %>%
  ...
  geom_line(data=predicted.incidence.increase,aes(x=Date,y=fit),color=rgb(255/255,0/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.increase,aes(x=Date,y=lwr),color="gray80") +
  geom_line(data=predicted.incidence.increase,aes(x=Date,y=upr),color="gray80") +
  
  geom_line(data=predicted.incidence.increase_2,aes(x=Date,y=fit),color=rgb(0/255,255/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.increase_2,aes(x=Date,y=lwr),color="gray80") +
  geom_line(data=predicted.incidence.increase_2,aes(x=Date,y=upr),color="gray80") +
  
  geom_line(data=predicted.incidence.descent.2,aes(x=Date,y=fit),color="yellow") +
  geom_line(data=predicted.incidence.descent.2,aes(x=Date,y=lwr),color="gray80") +
  geom_line(data=predicted.incidence.descent.2,aes(x=Date,y=upr),color="gray80") +
  
  geom_line(data=predicted.incidence.increase.3,aes(x=Date,y=fit),color=rgb(255/255,0/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.increase.3,aes(x=Date,y=lwr),color="gray80") +
  geom_line(data=predicted.incidence.increase.3,aes(x=Date,y=upr),color="gray80") +
  
  geom_line(data=predicted.incidence.decrease.3,aes(x=Date,y=fit),color=rgb(0/255,255/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.decrease.3,aes(x=Date,y=lwr),color="gray80") +
  geom_line(data=predicted.incidence.decrease.3,aes(x=Date,y=upr),color="gray80") +
  
  geom_line(data=predicted.incidence.increase.4,aes(x=Date,y=fit),color=rgb(255/255,0/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.increase.4,aes(x=Date,y=lwr),color="gray80") +
  geom_line(data=predicted.incidence.increase.4,aes(x=Date,y=upr),color="gray80") +
  
  geom_line(data=predicted.incidence.decrease.4,aes(x=Date,y=fit),color=rgb(0/255,255/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.decrease.4,aes(x=Date,y=lwr),color="gray80") +
  geom_line(data=predicted.incidence.decrease.4,aes(x=Date,y=upr),color="gray80") +
  
  geom_line(data=predicted.incidence.increase.5,aes(x=Date,y=fit),color=rgb(255/255,0/255,0/255,alpha=0.5)) +
  geom_line(data=predicted.incidence.increase.5,aes(x=Date,y=lwr),color="gray80") +
  geom_line(data=predicted.incidence.increase.5,aes(x=Date,y=upr),color="gray80") +
  
  geom_hline(yintercept = seq(0,12500,by=500),color="gray70") + 
  scale_y_continuous(limits=c(0,12500),breaks=seq(0,12500,by=500)) +
...
direct.label(p,list("last.bumpup",cex=0.6))
...
# df.250 <-
  read.csv(paste0(temp_dir,"/Cases_by_age.csv"),
    ...
    rename(Aldersgruppe=X.U.FEFF.Aldersgruppe) %>% 
...
ggplot(df.antigen_pcr,aes(x=Dato,y=AG_pos)) +
  ...
  labs(title="Daily Positive Antigen Tests",
       ...
       caption = timestamp_caption()) +
  scale_y_continuous(labels=scales::comma,expand=c(0,0),breaks=seq(0,15000,by=1000),limits=c(0,NA)) +
  scale_x_date(date_breaks = "14 days",date_labels = "%d %b %Y",expand=c(0,3)) +
  geom_smooth(span=0.2,color="gray20") + 
  theme_coviddk 
...
df.antigen_pcr %>% 
  ...
  scale_y_continuous(labels = scales::percent,expand=c(0,0),breaks=seq(0,1,by=0.01),limits=c(0,0.2)) +
...
read.csv(paste0(temp_dir,"/Test_pos_over_time.csv"),sep=";") %>% 
  ...
  scale_x_date(date_breaks = "1 month",limits=c(dmy("01-02-2020"),Sys.Date()+days(7)),date_labels = "%b %Y") +
    scale_y_continuous(limits=c(0,NA),breaks=seq(0,100000000,by=5000000),labels=scales::comma) +
  theme_coviddk +
...
read.csv(paste0(temp_dir,"/Test_pos_over_time.csv"),sep=";") %>% 
  ...
  geom_col() +
  labs(title="Daily New Positive Cases",x="Date",y="Daily New Positive Cases",
       caption = timestamp_caption()) +
  scale_x_date(date_breaks = "1 month",limits=c(dmy("01-02-2020"),Sys.Date()+days(7)),date_labels = "%b %Y") +
    scale_y_continuous(limits=c(0,NA),breaks=seq(0,100000,by=2500),expand=c(0,0),labels=scales::comma) +
  theme_coviddk +
  geom_smooth(span=0.1)
...
read.csv(paste0(temp_dir,"/Test_pos_over_time.csv"),sep=";") %>% 
  ...
  scale_y_continuous(limits=c(0,0.35),labels = scales::percent_format(accuracy = 0.2),expand=c(0,0),breaks = seq(0,1,by=0.025)) +
  geom_text(aes(label=scales::percent(x = PosPct,accuracy = 0.1)),angle=45,vjust=-0.1,hjust=-0.1,size=3)
...
read.csv(paste0(temp_dir,"/Test_pos_over_time.csv"),sep=";") %>% 
  ...
  labs(title="Number of PCR Tests vs. Positive-% by Month",
       ...
       caption = timestamp_caption()) +
  scale_y_continuous(limits=c(0,NA),breaks=seq(0,1,by=0.01),labels = scales::percent,expand=c(0,0))+
...
read.csv(paste0(temp_dir,"/Newly_admitted_over_time.csv"),sep=";") %>% 
  ...
  scale_x_date(date_breaks = "1 months",limits=c(dmy("01-02-2020"),Sys.Date()),date_labels = "%b") +
...
read.csv(paste0(temp_dir,"/Newly_admitted_over_time.csv"),sep=";") %>% 
  ...
  filter(Value>0) %>% 
  group_by(Metric) %>% 
  arrange(Metric,desc(Dato)) %>% 
  dplyr::mutate(Days_Since=as.integer(difftime(Dato,lead(Dato),units = "days"))) %>% 
  arrange(Metric,(Dato)) %>% 
  dplyr::mutate(Dato_rank=row_number()) %>% 
  ggplot(.,aes(x=Dato,y=Days_Since,fill=Metric)) +
  facet_wrap(~Metric,ncol=1,scales="free") +
  # geom_point() +
  geom_line() +
  theme_coviddk +
...
ggplot(df.deaths,aes(x=date,y=deaths)) +
  ...
  scale_x_date(date_breaks = "1 month",limits=c(dmy("01-02-2020"),Sys.Date()),date_labels = "%b %Y") +
...
read.csv(paste0(temp_dir,"/Deaths_over_time.csv"),sep=";") %>% 
  setNames(.,c("Dato","Value")) %>% 
  dplyr::mutate(Dato=ymd(Dato)) %>% 
  filter(Value>0) %>% 
  arrange(desc(Dato)) %>% 
  dplyr::mutate(Days_Since=as.integer(difftime(Dato,lead(Dato),units = "days"))) %>% 
  arrange((Dato)) %>% 
  dplyr::mutate(Dato_rank=row_number()) %>% 
  ggplot(.,aes(x=Dato,y=Days_Since)) +
  # geom_point() +
  geom_line() +
  theme_coviddk +
  theme(legend.position="null") +
...
ggplot(  
  ...
  scale_y_continuous(limits=c(0,NA),breaks = seq(0,5800000,by=250000),labels = scales::unit_format(accuracy = 0.1,unit = "M",scale = 1e-6,big.mark = ",")) +
...
df_calendar = bind_rows(
  ...
  data.frame(Group="Gruppe 4 Pt 3",Date=as.Date("2021171", "%Y%U%u"),y=0.3*10^6),
  ...
  data.frame(Group="Gruppe 10d3",Date=as.Date("2021231", "%Y%U%u"),y=2.0*10^6),
  data.frame(Group="Gruppe 10d4",Date=as.Date("2021271", "%Y%U%u"),y=2.7*10^6),
  data.frame(Group="Gruppe 11",Date=as.Date("2021291", "%Y%U%u"),y=2.7*10^6)
)
...
ggplot(df.predicted,aes(x=date,y=fit)) +
  ...
  geom_hline(yintercept = 5842000*0.9,color="green",alpha=1) +
  ...
  annotate(geom="text",x=dmy("14-02-2021"),y=5842000*0.87,label="90% vaccinated") +
...
Apparently removed in February 2022.
...
Apparently removed February 2022.

```{r eval=F,fig.width=6,fig.height=16}
...
#            colClasses=rep('character',num_cols)) %>%
#   as_tibble() %>% 
#   dplyr::mutate(Ugenummer=paste0(Ugenummer,"-1")) %>%
#   # dplyr::mutate(V1=gsub("W","",V1)) %>% 
#   dplyr::mutate(Ugenummer=ISOweek::ISOweek2date(Ugenummer)) %>% 
#   setNames(.,columnname) %>% 
...
order = c("1. Plejehjemsbeboere",
          ...
          "10D4. Personer fra årgang 1987-1991",
          "11. Personer fra årgang 2006-2009",
          "12. Personer fra årgang 2010-2017",
          "Resterende")
...
df %>%
  ...
  scale_x_date(date_labels = "W%U %Y",date_breaks = "3 week") +
...
file_path = paste0(temp_dir,"/Vaccination_sogne.csv")

num_cols = ncol(read.csv(file_path,
           header=FALSE,
           sep = ";"))

columnname = read.csv(file_path,
           header=FALSE,
           sep = ";")[1,] %>% 
  as.character %>% 
  paste0() %>% 
...
df_sogne = read.csv(file = file_path,
           # skip=1,
           header=TRUE,
           sep = ",",
           fileEncoding="latin1",
           colClasses=rep('character',num_cols)) %>% 
  dplyr::mutate(Inviterede_i_sognet=as.numeric(Inviterede_i_sognet),
                Antal_inviteret_ikke_booket=as.numeric(Antal_inviteret_ikke_booket))
...
df_sogne %>% 
  dplyr::mutate(prop_completed=(Inviterede_i_sognet-Antal_inviteret_ikke_booket)/Inviterede_i_sognet) %>% 
  dplyr::mutate(bottom_10pct=ifelse(prop_completed<quantile(prop_completed,0.05,na.rm=T),Sogn,NA)) %>% 
  ggplot(.,aes(x=Inviterede_i_sognet,Inviterede_i_sognet-Antal_inviteret_ikke_booket)) +
  geom_point(aes(color=Kommune)) +
  geom_abline(intercept = 0,slope = 1) +
  theme_coviddk +
  theme(legend.position="null") +
  scale_x_continuous(expand=c(0,0),breaks = seq(0,50000,by=5000)) +
  scale_y_continuous(expand=c(0,0),breaks = seq(0,50000,by=5000)) +
  labs(x="Invited in sogn",y="Booked in sogn") +
  geom_smooth() +
  geom_text(aes(label=bottom_10pct),size=3,hjust=-0.1)
