...
## If need working dir
#knitr::opts_chunk$set(echo=FALSE, results='hide', message=FALSE, warning=FALSE,
#                      root.dir = "D:/Dropbox/R/")  # should change the working directory to 'Users/Me/Docs/Proj'

```

```{r }
pacman::p_load(openxlsx,tibbletime,tidyverse,lubridate,tidyr,dplyr,tibble,drc,Ryacas,rvest,drc,tabulizer)
...
## DK: 14 Day Incidence per 100,000
...
df %>%
  ...
  geom_point() +
  scale_x_date(date_breaks = "1 week",limits=c(dmy("26-02-2020"),dmy("01-07-2021")),date_labels = "%d-%m") +
  scale_y_continuous(limits=c(0,1000),breaks=seq(0,1000,by=25)) +
  ...
  geom_hline(yintercept = seq(100,500,by=100)) + 
...
df %>%
  ggplot(.,aes(x=Date,y=INCIDENCE)) +
  geom_point() +
  scale_x_date(date_breaks = "1 week",limits=c(dmy("20-12-2020"),dmy("01-07-2021")),date_labels = "%d-%m") +
  scale_y_continuous(limits=c(0,1000),breaks=seq(0,1000,by=25)) +
  geom_abline(slope = -1,intercept = 200) +
  ...
  geom_vline(xintercept = unique(floor_date(seq.Date(dmy("20-12-2020"),dmy("01-07-2021"),by="1 day"),"month")),color="blue") +
  # geom_vline(xintercept = unique(floor_date(seq.Date(dmy("01-08-2020"),dmy("01-08-2030"),by="1 day"),"week")),color="grey50") +
  geom_hline(yintercept = seq(0,1000,by=100)) + 
  # geom_vline(xintercept = break_even_date,color="red") +
  theme(axis.text.x = element_text(angle = 90)) +
  labs(x="Date",y="14-day Incidence Per 100,000") 
...
df %>%
  ggplot(.,aes(x=Date,y=INCIDENCE)) +
  geom_point() +
  scale_x_date(date_breaks = "1 week",limits=c(dmy("16-02-2021"),dmy("01-04-2021")),date_labels = "%d-%m") +
  scale_y_continuous(limits=c(75,225),breaks=seq(75,225,by=25)) +
  geom_abline(slope = -1,intercept = 200) +
  ...
  geom_vline(xintercept = unique(floor_date(seq.Date(dmy("16-02-2021"),dmy("01-04-2021"),by="1 day"),"month")),color="blue") +
  # geom_vline(xintercept = unique(floor_date(seq.Date(dmy("01-08-2020"),dmy("01-08-2030"),by="1 day"),"week")),color="grey50") +
  geom_hline(yintercept = seq(0,1000,by=50)) + 
  # geom_vline(xintercept = break_even_date,color="red") +
  theme(axis.text.x = element_text(angle = 90)) +
  labs(x="Date",y="14-day Incidence Per 100,000") 
...
## DK: Number of Tests versus positive percentage
...
read.csv(paste0(temp_dir,"/Test_pos_over_time.csv"),sep=";") %>% 
  ...
  dplyr::mutate(Month=paste0(month(Date),"-",year(Date))) %>% 
...
read.csv(paste0(temp_dir,"/Test_pos_over_time.csv"),sep=";") %>% 
  ...
  theme(axis.text.x = element_text(angle = 90)) +
  labs(x="Date",y="% Positive") +
  scale_x_date(date_breaks = "1 week",limits=c(dmy("01-07-2020"),dmy("01-07-2021")),date_labels = "%d-%m") +
...
read.csv(paste0(temp_dir,"/Newly_admitted_over_time.csv"),sep=";") %>% 
  ...
  geom_point() +
  geom_smooth(span=0.1) +
  scale_x_date(date_breaks = "4 week",date_labels = "%d-%m",limits = )
...
df =
  ...
  geom_point() +
  geom_smooth(span=0.1) +
  geom_errorbar(ymin=df$uncertainty_lower,ymax=df$uncertainty_upper) +
  theme_bw() +
...
ggplot(  
  ...
  # scale_x_date(limits = c(dmy("27-12-2020"),dmy("01-06-2021")),expand=c(0,0)) +
  theme_bw() +
  scale_y_continuous(limits=c(0,NA))
```
